...
class DesktopStorage(models.Model):
    ...
    desktop = models.ForeignKey(
        Desktop, on_delete=models.CASCADE, related_name="storage_devices"
    )
...
class DesktopLog(models.Model):
    desktop = models.ForeignKey(Desktop, on_delete=models.CASCADE, related_name="logs")
    ...
    old_employee = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="desktop_old_employee_logs",
    )
    new_employee = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="desktop_new_employee_logs",
    )
    on_hand_date = models.DateField(blank=True, null=True)
    return_date = models.DateField(blank=True, null=True)
    branch = models.ForeignKey(
    ...
    def __str__(self):
        return f"Log for {self.desktop.serial} at {self.change_time}"
